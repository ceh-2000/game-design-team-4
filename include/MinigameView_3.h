...
public:
    ...
    void draw(const float &deltaTime, const float &round);

    void update(const float &deltaTime, const float &round);

    void updateBeatBoxes(const std::vector<BeatBoxLogic> &beatBoxes, const std::vector<BeatBoxLogic> &passedBoxes,
