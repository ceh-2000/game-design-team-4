...
Chart_Logic::Chart_Logic()
{
    ...
    this->play_button = std::make_shared<Button>(sf::Vector2f(this->WINDOW_SIZE.x / 2.0f, this->WINDOW_SIZE.y - 64.0f), sf::Vector2f(32.0f, 32.0f), "", TYPE::PLAY_BTN);
	this->stop_button = std::make_shared<Button>(sf::Vector2f(this->WINDOW_SIZE.x / 2.0f - 64.0f, this->WINDOW_SIZE.y - 64.0f), sf::Vector2f(32.0f, 32.0f), "", TYPE::STOP_BTN);
	...
	this->textField = std::make_shared<Button>(sf::Vector2f(this->WINDOW_SIZE.x - 64.0f, 16.0f), sf::Vector2f(64.0f, 16.0f), "", TYPE::TEXTFIELD);
