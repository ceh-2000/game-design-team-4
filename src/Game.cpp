...
//    this->logic_2->setKnifePos(sf::Vector2f(logic_2->getPosition().x + 1.5f * logic_2->getPRadius(), logic_2->getPosition().y));
...
void Game::switchToNewGame() {
	...
	switch(currentGame)
	{
		case 1:	//INSTANTIATE SOUS CHEF GAME
...
void Game::checkEvent(const float &deltaTime) {
	...
	while (this->app->pollEvent(event)) {
		switch (event.type) {
			case sf::Event::Closed: this->isActive = false; break; // Exit
			case sf::Event::KeyPressed:
				switch (event.key.code) {
					case sf::Keyboard::Q: this->isActive = false; break; // Exit
					...
					case sf::Keyboard::Escape:
						switch(this->currentGame){
							case 6:	this->main_menu->setCurrentScreen(0); break;
							default: break;
						}
						break;
					...
					case sf::Keyboard::Left:
						switch (this->currentGame) {
							case 1: this->logic_1->reactTap(this->logic->tapCheck(), false); break;
							case 4:	this->view_4->reachInput(multiArrowInput(), this->logic->tapCheck()); break;
						}
						break;
					case sf::Keyboard::Right:
						switch (this->currentGame) {
							case 1:	this->logic_1->reactTap(this->logic->tapCheck(), true);	break;
							case 4:	this->view_4->reachInput(multiArrowInput(), this->logic->tapCheck()); break;
						}
						break;
					case sf::Keyboard::Up:
						switch (this->currentGame) {
							case 4:	this->view_4->reachInput(multiArrowInput(), this->logic->tapCheck()); break;
							case 6:	this->main_menu->moveUp(); break;
						}
						break;
					...
					case sf::Keyboard::Down:
						switch (this->currentGame) {
							case 4:	this->view_4->reachInput(multiArrowInput(), this->logic->tapCheck()); break;
							case 6:	this->main_menu->moveDown(); break;
						}
						break;
					default: break;
				}
