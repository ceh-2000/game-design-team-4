...
MinigameView_2::MinigameView_2(std::shared_ptr<MinigameLogic_2> MinigameLogic_2,
    ...
    if (!backgroundTexture.loadFromFile("../data/art/pizza_background.jpg")) {
...
void MinigameView_2::drawBackground() {
